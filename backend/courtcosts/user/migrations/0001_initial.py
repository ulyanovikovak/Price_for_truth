    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calculation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='user.calculation')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='directory.categories')),
                ('inflation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='directory.inflation')),
            ],
            options={
